                ...
                if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                    if (existeFaturamentoEmAndamento()) {
                        if (validarCodigoBarras()) {
                            ...
                            JOptionPane.showMessageDialog(null, "Código de Barras inválilido");
                        }
                    } else {
...
JOptionPane.showConfirmDialog(null, "antes de itens");
            ...
            if (validarCliente()) {
                ...
                JOptionPane.showMessageDialog(null, "Busque um cliente vÃ¡lido!");
            }
            // 6 - REMOVER PRODUTO
    ...
    public void inserirItem() {
        //1Âº Cria e busca produto pelo Cod Barras
        ...
        //2Âº Adicionar produto e qtd; atribuindo a responsabilidade a venda de criar ItemDeVenda
        venda.adicionarItem(produto);
        //3Âº atualizar tabela da tela
        atualizarTabelaDeItens();
    }
    ...
    private void gravarVenda() {
        ...
        //ATRIBUIÃ‡ÃƒO DA PESSOA FÃ?SICA Ã‰ FEITA NA BUSCA - 10
        ...
        if (codigo == 0) {
            ...
            */
            ...
            for (ItemDeVenda itemDeVenda : venda.getItensDeVenda()) {
                ...
                //ESTOQUE: 2Âº setar a nova qtd no estoque
            ...
            //3Âºatualizar os itens c/ idVenda e incluir na tabela de itens de venda no banco          
            ...
            //4Âº atualizar conta a receber (BUSCA, ATUALIZA VALOR, E ATUALIZA)
