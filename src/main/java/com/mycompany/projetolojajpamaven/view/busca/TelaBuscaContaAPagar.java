...
public class TelaBuscaContaAPagar extends javax.swing.JDialog {

    public TelaBuscaContaAPagar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    TelaBuscaContaAPagar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable_ContasAPagar = new javax.swing.JTable();
        ...
        jTable_ContasAPagar.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "Id da Venda", "Valor Total", "Status"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jTable_ContasAPagar);
    ...
    private javax.swing.JTable jTable_ContasAPagar;
    ...
    public JTable getjTable_ContasAPagar() {
        return jTable_ContasAPagar;
    }
