...
public class TelaBuscaCidade extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTable_Cidades = new javax.swing.JTable();
        ...
        jTable_Cidades.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTable_Cidades);
        if (jTable_Cidades.getColumnModel().getColumnCount() > 0) {
            jTable_Cidades.getColumnModel().getColumn(0).setMaxWidth(50);
            jTable_Cidades.getColumnModel().getColumn(1).setMaxWidth(650);
            jTable_Cidades.getColumnModel().getColumn(2).setMaxWidth(50);
        }
    ...
    private javax.swing.JTable jTable_Cidades;
    ...
    public JTable getjTable_Cidades() {
        return jTable_Cidades;
    }
