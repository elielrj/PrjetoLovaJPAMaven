...
public class TelaBuscaEndereco extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTable_Enderecos = new javax.swing.JTable();
        ...
        jTable_Enderecos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Id", "Logradouro", "Número", "Bairro", "Cidade", "CEP", "Status"
            }
        ));
        jScrollPane1.setViewportView(jTable_Enderecos);
        if (jTable_Enderecos.getColumnModel().getColumnCount() > 0) {
            jTable_Enderecos.getColumnModel().getColumn(0).setMaxWidth(40);
            jTable_Enderecos.getColumnModel().getColumn(1).setMaxWidth(170);
            jTable_Enderecos.getColumnModel().getColumn(2).setMaxWidth(50);
            jTable_Enderecos.getColumnModel().getColumn(3).setMaxWidth(150);
            jTable_Enderecos.getColumnModel().getColumn(4).setMaxWidth(150);
            jTable_Enderecos.getColumnModel().getColumn(5).setMaxWidth(70);
            jTable_Enderecos.getColumnModel().getColumn(6).setMaxWidth(50);
        }
    ...
    private javax.swing.JTable jTable_Enderecos;
    ...
    public JTable getjTable_Enderecos() {
        return jTable_Enderecos;
    }
